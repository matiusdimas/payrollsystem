...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <h1>Form Tambah Hari</h1>
            <form action="/hari/add" method="post">
                <?= csrf_field() ?>
                <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input type="text"
                            ...
                            name="nik" value="<?= old('nik') ? old('nik') : '' ?>">
                ...
                <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input type="text"
                            ...
                            id="jabatan" name="jabatan" value="<?= old('jabatan') ? old('jabatan') : '' ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3 col">
                        ...
                        <input type="number"
                            ...
                            id="gaji_pokok" name="gaji_pokok" value="<?= old('gaji_pokok') ? old('gaji_pokok') : '' ?>">
                        <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="mb-3 col-6">
                        ...
                        <input type="number"
                            ...
                            id="tunjangan" name="tunjangan" value="<?= old('tunjangan') ? old('tunjangan') : '' ?>">
                        <div class="invalid-feedback">
                ...
                <a href="/hari" class="btn btn-danger">Back</a>
            </form>
        </div>
    </div>
</div>
